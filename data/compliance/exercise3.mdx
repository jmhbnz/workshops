...
> 
> ![workshop](/workshops/static/images/compliance/operator-framework.png)
...
<Zoom>
|![workshop](/workshops/static/images/compliance/install-compliance-operator.gif)         |
|:-----------------------------------------------------------------------------:|
...
<Zoom>
|![workshop](/workshops/static/images/compliance/installed-operators-1.png)               |
|:-----------------------------------------------------------------------------:|
...
<Zoom>
|![workshop](/workshops/static/images/compliance/installed-operators-2.png)               |
|:-----------------------------------------------------------------------------:|
| *List of installed operators*                                                 |
</Zoom>
