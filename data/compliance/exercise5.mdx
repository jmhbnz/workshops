...
<Zoom>
|![workshop](/workshops/static/images/compliance/compliance-scan-results.gif)             |
|:-----------------------------------------------------------------------------:|
...
<Zoom>
|![workshop](/workshops/static/images/compliance/compliance-scan-results-1.png)           |
|:-----------------------------------------------------------------------------:|
| *Compliance scan results in Red Hat Advanced Cluster Security*                |
</Zoom>

<Zoom>
|![workshop](/workshops/static/images/compliance/compliance-scan-results-2.png)           |
|:-----------------------------------------------------------------------------:|
| *Compliance scan results in Red Hat Advanced Cluster Security*                |
</Zoom>
...
<Zoom>
|![workshop](/workshops/static/images/compliance/compliance-scan-results-3.png)           |
|:-----------------------------------------------------------------------------:|
...
<Zoom>
|![workshop](/workshops/static/images/compliance/rhacs-violation-exclude.gif)             |
|:-----------------------------------------------------------------------------:|
