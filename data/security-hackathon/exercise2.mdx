...
![cluster](/workshops/static/images/security/pairing.png)
...
<Zoom>
|![central architecture](/workshops/static/images/security/central.png)                   | 
|:-----------------------------------------------------------------------------:|
...
<Zoom>
|![cluster](/workshops/static/images/security/init-bundle.png)                            | 
|:-----------------------------------------------------------------------------:|
...
<Zoom>
|![secured cluster](/workshops/static/images/security/secured-cluster.png)                | 
|:-----------------------------------------------------------------------------:|
...
![completed pair session](/workshops/static/images/security/completed.png)
