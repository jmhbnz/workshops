...
Register for an environment using `<team name>@redhat.com`. This way all your team members will be able to see the same cluster details for your shared team cluster.
