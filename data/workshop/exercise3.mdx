...
> Note: To learn more about **Deployments** refer to this [documentation](https://docs.openshift.com/container-platform/4.20/applications/deployments/what-deployments-are.html).
...
Start in the **Topology** view of the web console.
...
Start in the **Topology** view of the **Workloads** perspective and click your Parksmap application icon.
...
In the **Topology** view of the **Workloads** perspective click your Parksmap application icon.
...
*Scaling up the ParksMap application frontend*
</Zoom>
...
```bash
bash-5.1 ~ $ oc delete pod parksmap-ff7477dc4-2nxd2
...
Before moving on feel free to take a moment to review the concepts of [HorizontalPodAutoscaling](https://docs.openshift.com/container-platform/4.20/nodes/pods/nodes-pods-autoscaling.html), [VerticalPodAutoscaling](https://docs.openshift.com/container-platform/4.20/nodes/pods/nodes-pods-vertical-autoscaler.html) and [Cluster autoscaling](https://docs.openshift.com/container-platform/4.20/machine_management/applying-autoscaling.html).

Well done, you've finished exercise 3! 🎉

Feel free to explore these concepts further and when you're ready you can move on to [Exercise 4](/workshop/exercise4).
