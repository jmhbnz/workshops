...
An OpenShift `4.20` cluster has already been provisioned for you to complete these excercises. Open your web browser and navigate to the workshop login page [https://catalog.demo.redhat.com/workshop/djzt3z](https://catalog.demo.redhat.com/workshop/djzt3z).
...
## 1.4 - Switching between views

Different roles have different needs when it comes to viewing details within the OpenShift web console. These different sections of information are accessed from the left menu in the OpenShift Web Console.

In this workshop we will be focusing on how we deliver applications onto the platform so we'll be spending a lot of time within the **Workloads** view of the web console. Let's take a quick look at that now.

Select **Workloads** section then select the **Topology** view.
...
Well done, you're now ready to move on to [Exercise 2](/workshop/exercise2) and deploy an application! 🎉
