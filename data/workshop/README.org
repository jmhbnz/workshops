...
#+RESULTS:
#+begin_example
namespace "openshift-gitops-operator" deleted
operatorgroup.operators.coreos.com "openshift-gitops-operator" deleted from openshift-gitops-operator namespace
subscription.operators.coreos.com "openshift-gitops-operator" deleted from openshift-gitops-operator namespace
#+end_example
