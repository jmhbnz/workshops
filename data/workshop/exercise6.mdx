...
Start by clicking **Quick create** in the top right corner.
...
Select **Python** as the **Builder Image** type and **Python 3.9-ubi8** as the **Builder Image Version**.
...
To see the build logs, in **Topology** view of the **Workloads** perspective, click the nationalparks python icon, then click on **View Logs** in the **Builds** section of the **Resources** tab.
